package com.insightsoftware.brewer.validation.validator;
...
public class AtributoConfirmacaoValidator
  ...
  public boolean isValid(Object object, ConstraintValidatorContext context) {
    ...
    try {
      ...
      valido =
          ambosSaoNull(valorAtributo, valorAtributoConfirmacao) || ambosSaoIguais(valorAtributo,
              valorAtributoConfirmacao);
    } catch (Exception e) {
